...
class DateViewHelper extends FluidDateViewHelper
{
     ...
     * @api
     */
    public function render($date = null, $format = 'Y-m-d', $localeFormatType = null, $localeFormatLength = null, $cldrFormat = null, $timezone = null)
    {
        if ($date === null) {
        ...
        return parent::render($date->setTimezone(new \DateTimeZone($timezone)), $format, $localeFormatType, $localeFormatLength, $cldrFormat);
    }
}
